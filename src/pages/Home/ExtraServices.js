                                ...
                                <div className="bg-base-100 shadow-xl">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className='text-lg text-[#777]'>
                                            ...
                                            <p className='flex items-center gap-2 mb-2'><IoCheckmarkOutline className='text-primary text-xl' />Orci miss natoque vasa ince</p>
                                            <p className='flex items-center gap-2'><AiOutlineClose className='text-xl text' />Clean sorem ipsum morbin</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-base-100 shadow-xl">
