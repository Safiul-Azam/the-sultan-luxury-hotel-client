        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8 w-full collapse'>
             {
                ...
                >
                    ...
                    <div className="text-white absolute -bottom-10 group-hover:bottom-10 group-hover:duration-500 group-hover:ease-out ease-in-out duration-500 w-full px-6">
                        ...
                        <div className="inline-flex justify-between w-full items-center mt-5">
